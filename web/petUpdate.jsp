    ...
    <div class="row">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">修改宠物信息</h3>
            </div>
                ...
                <div class="result-wrap">
                    <div class="result-content">
                        <form  id="add-pet"  enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="formerImg" value="${pet.img}">
                            ...
                            <table class="insert-tab" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="common-text required" id="title" name="name" size="50" value="${pet.name}" type="text">
                                    </td>
                                </tr>
                                <tr>
                                    <th width="120">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="isJY" id="isJY" class="required common-text" >
                                            <option value="" disabled selected>请选择</option>
                                            <option value="1" <c:if test="${pet.isJY == 1}">selected</c:if>>是</option>
                                            <option value="2" <c:if test="${pet.isJY == 2}">selected</c:if>>否</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input class="common-text" name="character" size="50" value="${pet.character}" type="text">
                                    </td>
                                </tr>
                                <tr>
                                    <th>发布时间：</th>
                                    <td>
                                        <input type="text" disabled name="createTime"  value="${pet.createTime}" min="1900-01-01" max="2200-04-12" class="common-text">
                                    </td>
                                </tr>
                                <tr>
                                    <th>所属宠物店：</th>
                                    <td>
                                        <input class="common-text" disabled name="organization" value="${pet.organization}" size="50" type="text">
                                    </td>
                                </tr>
                                <tr>
                                    <th>饲主：</th>
                                    <td>
                                        <input class="common-text" disabled name="feeder" value="${pet.feeder}" size="50"  type="text">
                                    </td>
                                </tr>
                                <tr>
                                    <th>
