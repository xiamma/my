...
!function (t, e) {
    ...
    var n = function (t) {
        ...
        r = function (t) {
        ...
        })), s = {}.propertyIsEnumerable, l = Object.getOwnPropertyDescriptor, c = {
            f: l && !s.call({1: 2}, 1) ? function (t) {
                var e = l(this, t);
                return !!e && e.enumerable
            } : s
        }, h = function (t, e) {
            return {enumerable: !(1 & t), configurable: !(2 & t), writable: !(4 & t), value: e}
        }, u = {}.toString, d = function (t) {
            return u.call(t).slice(8, -1)
        }, p = "".split, f = r((function () {
        ...
        }, m = {}.hasOwnProperty, w = function (t, e) {
            return m.call(t, e)
        }, S = o.document, x = b(S) && b(S.createElement), k = function (t) {
        ...
        })), C = Object.getOwnPropertyDescriptor, T = {
            f: a ? C : function (t, e) {
            ...
            return e
        }, E = "__core-js_shared__", j = o[E] || R(E, {}), N = Function.toString;
    "function" != typeof j.inspectSource && (j.inspectSource = function (t) {
        return N.call(t)
    });
    var _, F, D, V = j.inspectSource, B = o.WeakMap, L = "function" == typeof B && /native code/.test(V(B)),
        H = i((function (t) {
        ...
        })), M = 0, U = Math.random(), z = function (t) {
            return "Symbol(" + String(void 0 === t ? "" : t) + ")_" + (++M + U).toString(36)
        }, q = H("keys"), W = function (t) {
            return q[t] || (q[t] = z(t))
        }, G = {}, K = o.WeakMap;
    if (L) {
        var Y = new K, J = Y.get, X = Y.has, Q = Y.set;
        _ = function (t, e) {
    ...
    var tt, et = {
            set: _, get: F, has: D, enforce: function (t) {
                return D(t) ? F(t) : _(t, {})
            ...
            var e = et.get, i = et.enforce, n = String(String).split("String");
            (t.exports = function (t, e, r, a) {
                var s = !!a && !!a.unsafe, l = !!a && !!a.enumerable, c = !!a && !!a.noTargetGet;
        ...
        }, at = Math.ceil, st = Math.floor, lt = function (t) {
            return isNaN(t = +t) ? 0 : (t > 0 ? st : at)(t)
        }, ct = Math.min, ht = function (t) {
            return t > 0 ? ct(lt(t), 9007199254740991) : 0
        }, ut = Math.max, dt = Math.min, pt = function (t, e) {
            var i = lt(t);
            return i < 0 ? ut(i + e, 0) : dt(i, e)
        }, ft = function (t) {
            return function (e, i, n) {
                var o, r = v(e), a = ht(r.length), s = pt(n, a);
                if (t && i != i) {
                    for (; a > s;) if ((o = r[s++]) != o) return !0
                } else for (; a > s; s++) if ((t || s in r) && r[s] === i) return t || s || 0;
                return !t && -1
            }
        }, gt = {includes: ft(!0), indexOf: ft(!1)}, vt = gt.indexOf, bt = function (t, e) {
            var i, n = v(t), o = 0, r = [];
        ...
        mt = yt.concat("length", "prototype"), wt = {
            f: Object.getOwnPropertyNames || function (t) {
                return bt(t, mt)
            }
        }, St = {f: Object.getOwnPropertySymbols}, xt = rt("Reflect", "ownKeys") || function (t) {
            var e = wt.f(P(t)), i = St.f;
        ...
        }, Ot = /#|\.prototype\./, Ct = function (t, e) {
            var i = Pt[Tt(t)];
            return i == At || i != It && ("function" == typeof e ? r(e) : !!e)
        }, Tt = Ct.normalize = function (t) {
            return String(t).replace(Ot, ".").toLowerCase()
        }, Pt = Ct.data = {}, It = Ct.NATIVE = "N", At = Ct.POLYFILL = "P", $t = Ct, Rt = T.f, Et = function (t, e) {
            var i, n, r, a, s, l = t.target, c = t.global, h = t.stat;
            if (i = c ? o : h ? o[l] || R(l, {}) : (o[l] || {}).prototype) for (n in e) {
        ...
        })), Nt = jt && !Symbol.sham && "symbol" == typeof Symbol(), _t = Array.isArray || function (t) {
            return "Array" == d(t)
        }, Ft = function (t) {
            return Object(g(t))
            ...
            return t
        }, Bt = rt("document", "documentElement"), Lt = W("IE_PROTO"), Ht = function () {
        }, Mt = function (t) {
    ...
    var zt = Object.create || function (t, e) {
        ...
        Kt = {
        ...
        }, le = [].push, ce = function (t) {
            var e = 1 == t, i = 2 == t, n = 3 == t, o = 4 == t, r = 6 == t, a = 5 == t || r;
            return function (s, l, c, h) {
                ...
                }(l, c, 3), b = ht(g.length), y = 0, m = h || se, w = e ? m(s, b) : i ? m(s, 0) : void 0; b > y; y++) if ((a || y in g) && (d = v(u = g[y], y, p), t)) if (e) w[y] = d; else if (d) switch (t) {
                    case 3:
                        return !0;
                    case 5:
                        return u;
        ...
        ue = he.forEach, de = W("hidden"), pe = "Symbol", fe = Qt("toPrimitive"), ge = et.set, ve = et.getterFor(pe),
        be = Object.prototype, ye = o.Symbol, me = rt("JSON", "stringify"), we = T.f, Se = A.f, xe = Kt.f, ke = c.f,
        Oe = H("symbols"), Ce = H("op-symbols"), Te = H("string-to-symbol-registry"),
        Pe = H("symbol-to-string-registry"), Ie = H("wks"), Ae = o.QObject,
        $e = !Ae || !Ae.prototype || !Ae.prototype.findChild, Re = a && r((function () {
            return 7 != zt(Se({}, "a", {
                get: function () {
            ...
            P(t);
            var i = v(e), n = Dt(i).concat(Be(i));
            return ue(n, (function (e) {
                a && !Fe.call(i, e) || Ne(t, e, i[e])
            })), t
        }, Fe = function (t) {
            var e = y(t, !0), i = ke.call(this, e);
    ...
    if (jt || (it((ye = function () {
        ...
        var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0, e = z(t),
            i = function (t) {
    ...
    }), it(be, "propertyIsEnumerable", Fe, {unsafe: !0}))), Nt || (Zt.f = function (t) {
        return Ee(Qt(t), t)
    }), Et({global: !0, wrap: !0, forced: !jt, sham: !jt}, {Symbol: ye}), ue(Dt(Ie), (function (t) {
        ee(t)
    })), Et({target: pe, stat: !0, forced: !jt}, {
        for: function (t) {
            var e = String(t);
    ...
    }), Et({target: "Object", stat: !0, forced: !jt, sham: !a}, {
        create: function (t, e) {
            return void 0 === e ? zt(t) : _e(zt(t), e)
        }, defineProperty: Ne, defineProperties: _e, getOwnPropertyDescriptor: De
    }), Et({target: "Object", stat: !0, forced: !jt}, {
        ...
        Et({target: "JSON", stat: !0, forced: Le}, {
    ...
    if (a && "function" == typeof Me && (!("description" in Me.prototype) || void 0 !== Me().description)) {
        ...
        qe.constructor = ze;
        var We = qe.toString, Ge = "Symbol(test)" == String(Me("test")), Ke = /^Symbol\((.*)\)[^)]+$/;
        He(qe, "description", {
            configurable: !0, get: function () {
                var t = b(this) ? this.valueOf() : this, e = We.call(t);
                if (w(Ue, t)) return "";
    ...
    }, Qe = rt("navigator", "userAgent") || "", Ze = o.process, ti = Ze && Ze.versions, ei = ti && ti.v8;
    ei ? Je = (Ye = ei.split("."))[0] + Ye[1] : Qe && (!(Ye = Qe.match(/Edge\/(\d+)/)) || Ye[1] >= 74) && (Ye = Qe.match(/Chrome\/(\d+)/)) && (Je = Ye[1]);
    var ii = Je && +Je, ni = Qt("species"), oi = function (t) {
        ...
        }, ri = Qt("isConcatSpreadable"), ai = 9007199254740991, si = "Maximum allowed index exceeded",
        li = ii >= 51 || !r((function () {
            var t = [];
            return t[ri] = !1, t.concat()[0] !== t
        })), ci = oi("concat"), hi = function (t) {
            if (!b(t)) return !1;
            var e = t[ri];
            return void 0 !== e ? !!e : _t(t)
        };
    Et({target: "Array", proto: !0, forced: !li || !ci}, {
        concat: function (t) {
            var e, i, n, o, r, a = Ft(this), s = se(a, 0), l = 0;
            for (e = -1, n = arguments.length; e < n; e++) if (hi(r = -1 === e ? a : arguments[e])) {
    ...
    }, Ci = gt.indexOf, Ti = [].indexOf, Pi = !!Ti && 1 / [1].indexOf(1, -0) < 0, Ii = Oi("indexOf");
    Et({target: "Array", proto: !0, forced: Pi || Ii}, {
        indexOf: function (t) {
    ...
    })), ji = W("IE_PROTO"), Ni = Object.prototype, _i = Ei ? Object.getPrototypeOf : function (t) {
    ...
    var Vi = {IteratorPrototype: Ai, BUGGY_SAFARI_ITERATORS: Di}, Bi = Vi.IteratorPrototype,
        ...
        }() : void 0), Hi = Vi.IteratorPrototype, Mi = Vi.BUGGY_SAFARI_ITERATORS, Ui = Qt("iterator"), zi = "keys",
        qi = "values", Wi = "entries", Gi = function () {
            return this
            ...
            var s, l, c, u = function (t) {
                ...
                }, d = e + " Iterator", p = !1, f = t.prototype, g = f[Ui] || f["@@iterator"] || o && f[o],
                v = !Mi && g || u(o), b = "Array" == e && f.entries || g;
            if (b && (s = _i(b.call(new t)), Hi !== Object.prototype && s.next && (_i(s) !== Hi && (Li ? Li(s, Hi) : "function" != typeof s[Ui] && $(s, Ui, Gi)), oe(s, d, !0))), o == qi && g && g.name !== qi && (p = !0, v = function () {
                ...
                keys: r ? v : u(zi),
                entries: u(Wi)
            }, a) for (c in l) (Mi || p || !(c in f)) && it(f, c, l[c]); else Et({
                target: e,
                proto: !0,
                forced: Mi || p
            }, l);
            return l
        }, Yi = "Array Iterator", Ji = et.set, Xi = et.getterFor(Yi), Qi = Ki(Array, "Array", (function (t, e) {
            Ji(this, {type: Yi, target: v(t), index: 0, kind: e})
        }), (function () {
            var t = Xi(this), e = t.target, i = t.kind, n = t.index++;
    ...
    var Zi = [].join, tn = f != Object, en = Oi("join", ",");
    Et({target: "Array", proto: !0, forced: tn || en}, {
        join: function (t) {
            return Zi.call(v(this), void 0 === t ? "," : t)
        }
    });
    var nn = he.map, on = oi("map"), rn = on && !r((function () {
        [].map.call({length: -1, 0: 1}, (function (t) {
            throw t
        }))
    }));
    Et({target: "Array", proto: !0, forced: !on || !rn}, {
        map: function (t) {
            return nn(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var an = [].reverse, sn = [1, 2];
    Et({target: "Array", proto: !0, forced: String(sn) === String(sn.reverse())}, {
        reverse: function () {
            return _t(this) && (this.length = this.length), an.call(this)
        }
    });
    var ln = Qt("species"), cn = [].slice, hn = Math.max;
    Et({target: "Array", proto: !0, forced: !oi("slice")}, {
        slice: function (t, e) {
            var i, n, o, r = v(this), a = ht(r.length), s = pt(t, a), l = pt(void 0 === e ? a : e, a);
    ...
    var un = [], dn = un.sort, pn = r((function () {
        un.sort(void 0)
    })), fn = r((function () {
        un.sort(null)
    })), gn = Oi("sort");
    Et({target: "Array", proto: !0, forced: pn || !fn || gn}, {
        sort: function (t) {
            return void 0 === t ? dn.call(Ft(this)) : dn.call(Ft(this), re(t))
        }
    });
    var vn = Math.max, bn = Math.min, yn = 9007199254740991, mn = "Maximum allowed length exceeded";
    Et({target: "Array", proto: !0, forced: !oi("splice")}, {
        splice: function (t, e) {
            var i, n, o, r, a, s, l = Ft(this), c = ht(l.length), h = pt(t, c), u = arguments.length;
    ...
    var wn = function (t, e, i) {
        ...
        }, Sn = "\t\n\v\f\r                　\u2028\u2029\ufeff", xn = "[" + Sn + "]", kn = RegExp("^" + xn + xn + "*"),
        On = RegExp(xn + xn + "*$"), Cn = function (t) {
            return function (e) {
                var i = String(g(e));
                return 1 & t && (i = i.replace(kn, "")), 2 & t && (i = i.replace(On, "")), i
            }
        }, Tn = {start: Cn(1), end: Cn(2), trim: Cn(3)}, Pn = wt.f, In = T.f, An = A.f, $n = Tn.trim, Rn = "Number",
        En = o.Number, jn = En.prototype, Nn = d(zt(jn)) == Rn, _n = function (t) {
    ...
    var Ln = Object.assign, Hn = Object.defineProperty, Mn = !Ln || r((function () {
        if (a && 1 !== Ln({b: 1}, Ln(Hn({}, "a", {
    ...
    var Wn = {};
    Wn[Qt("toStringTag")] = "z";
    var Gn = "[object z]" === String(Wn), Kn = Qt("toStringTag"), Yn = "Arguments" == d(function () {
        return arguments
    }()), Jn = Gn ? d : function (t) {
        var e, i, n;
    ...
    var co = {
        ...
        }, ho = Qt("species"), uo = A.f, po = wt.f, fo = et.set, go = Qt("match"), vo = o.RegExp, bo = vo.prototype,
        yo = /a/g, mo = /a/g, wo = new vo(yo) !== yo, So = co.UNSUPPORTED_Y;
    if (a && $t("RegExp", !wo || So || r((function () {
        return mo[go] = !1, vo(yo) != yo || vo(mo) == mo || "/a/i" != vo(yo, "i")
    })))) {
        for (var xo = function (t, e) {
            var i, n = this instanceof xo, o = ao(t), r = void 0 === e;
    ...
    var To = RegExp.prototype.exec, Po = String.prototype.replace, Io = To, Ao = function () {
        var t = /a/, e = /b*/g;
        return To.call(t, "a"), To.call(e, "a"), 0 !== t.lastIndex || 0 !== e.lastIndex
    }(), $o = co.UNSUPPORTED_Y || co.BROKEN_CARET, Ro = void 0 !== /()??/.exec("")[1];
    (Ao || Ro || $o) && (Io = function (t) {
        var e, i, n, o, r = this, a = $o && r.sticky, s = so.call(r), l = r.source, c = 0, h = t;
    ...
    var jo = "toString", No = RegExp.prototype, _o = No.toString, Fo = r((function () {
        return "/a/b" != _o.call({source: "a", flags: "b"})
    })), Do = _o.name != jo;
    (Fo || Do) && it(RegExp.prototype, jo, (function () {
        var t = P(this), e = String(t.source), i = t.flags;
    ...
    Et({target: "String", proto: !0, forced: !Lo("includes")}, {
        includes: function (t) {
    ...
    var Ho = function (t) {
            return function (e, i) {
                var n, o, r = String(g(e)), a = lt(i), s = r.length;
        ...
        }, Mo = {codeAt: Ho(!1), charAt: Ho(!0)}, Uo = Mo.charAt, zo = "String Iterator", qo = et.set,
        Wo = et.getterFor(zo);
    Ki(String, "String", (function (t) {
        qo(this, {type: zo, string: String(t), index: 0})
    }), (function () {
        var t, e = Wo(this), i = e.string, n = e.index;
        return n >= i.length ? {value: void 0, done: !0} : (t = Uo(i, n), e.index += t.length, {value: t, done: !1})
    }));
    var Go = Qt("species"), Ko = !r((function () {
        var t = /./;
        return t.exec = function () {
            var t = [];
            return t.groups = {a: "7"}, t
        }, "7" !== "".replace(t, "$<a>")
    })), Yo = "$0" === "a".replace(/./, "$0"), Jo = !r((function () {
        var t = /(?:)/, e = t.exec;
        t.exec = function () {
        ...
        if (!a || !s || "replace" === t && (!Ko || !Yo) || "split" === t && !Jo) {
            var l = /./[o], c = i(o, ""[t], (function (t, e, i, n, o) {
                return e.exec === Eo ? a && !o ? {done: !0, value: l.call(e, i, n)} : {
                    done: !0,
                    value: t.call(i, e, n)
                } : {done: !1}
            }), {REPLACE_KEEPS_$0: Yo}), h = c[0], u = c[1];
    ...
    }, Qo = Mo.charAt, Zo = function (t, e, i) {
        ...
        return Eo.call(t, e)
    }, er = Math.max, ir = Math.min, nr = Math.floor, or = /\$([$&'`]|\d\d?|<[^>]*>)/g, rr = /\$([$&'`]|\d\d?)/g;
    Xo("replace", 2, (function (t, e, i, n) {
        return [function (i, n) {
            var o = g(this), r = null == i ? void 0 : i[t];
            ...
            var s = P(t), l = String(this), c = "function" == typeof r;
            c || (r = String(r));
            var h = s.global;
            if (h) {
                var u = s.unicode;
        ...
        function o(t, i, n, o, r, a) {
            var s = n + t.length, l = o.length, c = rr;
    ...
    Xo("search", 1, (function (t, e, i) {
        return [function (e) {
            var i = g(this), n = null == e ? void 0 : e[t];
            return void 0 !== n ? n.call(e, i) : new RegExp(e)[t](String(i))
        }, function (t) {
            var n = i(e, t, this);
            if (n.done) return n.value;
            var o = P(t), r = String(this), a = o.lastIndex;
            ar(a, 0) || (o.lastIndex = 0);
            var s = tr(o, r);
            return ar(o.lastIndex, a) || (o.lastIndex = a), null === s ? -1 : s.index
        }]
    }));
    var sr = Qt("species"), lr = [].push, cr = Math.min, hr = 4294967295, ur = !r((function () {
        return !RegExp(hr, "y")
    }));
    Xo("split", 2, (function (t, e, i) {
        ...
        return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (t, i) {
            var n = String(g(this)), o = void 0 === i ? hr : i >>> 0;
            if (0 === o) return [];
            ...
            var a = P(t), s = String(this), l = function (t, e) {
                ...
                u = new l(ur ? a : "^(?:" + a.source + ")", h), d = void 0 === o ? hr : o >>> 0;
            if (0 === d) return [];
    ...
    var pr = {
        ...
        TextTrackList: 0,
        TouchList: 0
    }, fr = he.forEach, gr = Oi("forEach") ? function (t) {
        return fr(this, t, arguments.length > 1 ? arguments[1] : void 0)
    } : [].forEach;
    for (var vr in pr) {
        var br = o[vr], yr = br && br.prototype;
    ...
    var mr = Qt("iterator"), wr = Qt("toStringTag"), Sr = Qi.values;
    for (var xr in pr) {
        var kr = o[xr], Or = kr && kr.prototype;
        if (Or) {
            if (Or[mr] !== Sr) try {
                $(Or, mr, Sr)
            } catch (t) {
            ...
            if (Or[wr] || $(Or, wr, xr), pr[xr]) for (var Cr in Qi) if (Or[Cr] !== Qi[Cr]) try {
                $(Or, Cr, Qi[Cr])
            } catch (t) {
                Or[Cr] = Qi[Cr]
            }
    ...
    var Br = {
        ...
        LOCALES: {en: Dr, "en-US": Dr}
    }, Lr = r((function () {
        Dt(1)
    }));
    Et({target: "Object", stat: !0, forced: Lr}, {
        keys: function (t) {
            return Dt(Ft(t))
        }
    });
    var Hr, Mr = T.f, Ur = "".endsWith, zr = Math.min, qr = Lo("endsWith"),
        Wr = !(qr || (Hr = Mr(String.prototype, "endsWith"), !Hr || Hr.writable));
    Et({target: "String", proto: !0, forced: !Wr && !qr}, {
        endsWith: function (t) {
            var e = String(g(this));
            Vo(t);
            var i = arguments.length > 1 ? arguments[1] : void 0, n = ht(e.length), o = void 0 === i ? n : zr(ht(i), n),
                r = String(t);
            return Ur ? Ur.call(e, r, o) : e.slice(o - r.length, o) === r
        }
    });
    var Gr = T.f, Kr = "".startsWith, Yr = Math.min, Jr = Lo("startsWith"), Xr = !Jr && !!function () {
        var t = Gr(String.prototype, "startsWith");
        return t && !t.writable
    }();
    Et({target: "String", proto: !0, forced: !Xr && !Jr}, {
        startsWith: function (t) {
            var e = String(g(this));
            Vo(t);
            var i = ht(Yr(arguments.length > 1 ? arguments[1] : void 0, e.length)), n = String(t);
    ...
    var Qr = {
        getSearchInput: function (e) {
            ...
            var o = !0, r = 0, a = t.replace(/%s/g, (function () {
                var t = i[r++];
            ...
            for (var h = 0; h < t.length; h++) {
                var u = !0, d = !1, p = void 0;
                try {
                    for (var f, g = t[h][Symbol.iterator](); !(u = (f = g.next()).done); u = !0) {
                        var v = f.value, b = v.rowspan || 1, y = v.colspan || 1, m = i[h].indexOf(!1);
            ...
            var e, i = (e = []).concat.apply(e, Rr(t)), n = !0, o = !1, r = void 0;
            try {
                for (var a, s = t[Symbol.iterator](); !(n = (a = s.next()).done); n = !0) {
                    var l = a.value, c = !0, h = !1, u = void 0;
                    try {
            ...
            for (var e = 0, i = Object.entries(t); e < i.length; e++) {
                var n = $r(i[e], 2), o = n[0], r = n[1], a = o.split(/(?=[A-Z])/).join("-").toLowerCase();
            ...
            var o = e.split("."), r = !0, a = !1, s = void 0;
            try {
            ...
            try {
                for (var o, r = t[Symbol.iterator](); !(e = (o = r.next()).done); e = !0) for (var a = o.value, s = 0, l = Object.keys(a); s < l.length; s++) {
                    var c = l[s];
        ...
        return Ar(t, [{
            key: "initDOM", value: function (t, e) {
                ...
                var i = this.initData(t, this.getNum(e)), n = i.rows.join(""), o = this.checkChanges("data", n),
                    r = this.checkChanges("top", i.topOffset), a = this.checkChanges("bottom", i.bottomOffset), s = [];
            ...
            key: "initData", value: function (t, e) {
                ...
                var i = Math.max((this.clusterRows - 50) * e, 0), n = i + this.clusterRows,
                    o = Math.max(i * this.itemHeight, 0), r = Math.max((t.length - n) * this.itemHeight, 0), a = [],
                    s = i;
                o < 1 && s++;
        ...
        return Ar(e, [{
            ...
            key: "initLocale", value: function () {
                if (this.options.locale) {
                    var e = t.fn.bootstrapTable.locales, i = this.options.locale.split(/-|_/);
            ...
            key: "initHeader", value: function () {
                ...
                this.header = {
                    ...
                    0 === o && Qr.hasDetailViewIcon(e.options) && (r = '<th class="detail" rowspan="'.concat(e.options.columns.length, '">\n          <div class="fht-cell"></div>\n          </th>')), r && "right" !== e.options.detailViewAlign && n.push(r), t.forEach((function (t, r) {
                        var a = Qr.sprintf(' class="%s"', t.class), s = t.widthUnit, l = parseFloat(t.width),
                        ...
                        if (u += Qr.sprintf("width: %s; ", !t.checkbox && !t.radio || l ? l ? l + s : void 0 : t.showSelectTitle ? void 0 : "36px"), void 0 !== t.fieldIndex || t.visible) {
                            var d = Qr.calculateObjectValue(null, e.options.headerStyle, [t]), p = [], f = "";
                            if (d && d.css) for (var g = 0, v = Object.entries(d.css); g < v.length; g++) {
                                var b = $r(v[g], 2), y = b[0], m = b[1];
                            ...
                            var w = e.options.escape ? Qr.escapeHTML(t.title) : t.title, S = w;
            ...
            key: "initSort", value: function () {
                ...
                -1 !== n ? (this.options.sortStable && this.data.forEach((function (t, e) {
                    ...
                    var a = Qr.getItemField(o, e, t.options.escape), s = Qr.getItemField(r, e, t.options.escape),
            ...
            key: "onSort", value: function (e) {
                var i = e.type, n = e.currentTarget, o = "keypress" === i ? t(n) : t(n).parent(),
            ...
            key: "initToolbar", value: function () {
                var e, i = this, n = this.options, o = [], r = 0, a = 0;
                this.$toolbar.find(".bs-bars").children().length && t("body").append(t(n.toolbar)), this.$toolbar.html(""), "string" != typeof n.toolbar && "object" !== Tr(n.toolbar) || t(Qr.sprintf('<div class="bs-bars %s-%s"></div>', this.constants.classes.pull, n.toolbarAlign)).appendTo(this.$toolbar).append(t(n.toolbar)), o = ['<div class="'.concat(["columns", "columns-".concat(n.buttonsAlign), this.constants.classes.buttonsGroup, "".concat(this.constants.classes.pull, "-").concat(n.buttonsAlign)].join(" "), '">')], "string" == typeof n.buttonsOrder && (n.buttonsOrder = n.buttonsOrder.replace(/\[|\]| |'/g, "").split(",")), this.buttons = Object.assign(this.buttons, {
                    paginationSwitch: {
                        ...
                        attributes: {"aria-label": n.formatPaginationSwitch(), title: n.formatPaginationSwitch()}
                    },
                    refresh: {
                        ...
                        render: !1,
                        event: this.refresh,
                        attributes: {"aria-label": n.formatRefresh(), title: n.formatRefresh()}
                    },
                    toggle: {
                        text: n.formatToggle(),
                        ...
                        attributes: {"aria-label": n.formatToggleOn(), title: n.formatToggleOn()}
                    },
                    fullscreen: {
                        ...
                        attributes: {"aria-label": n.formatFullscreen(), title: n.formatFullscreen()}
                    },
                    columns: {
                ...
                for (var s = {}, l = 0, c = Object.entries(this.buttons); l < c.length; l++) {
                    var h = $r(c[l], 2), u = h[0], d = h[1], p = void 0;
                    if (d.hasOwnProperty("html")) "function" == typeof d.html ? p = d.html() : "string" == typeof d.html && (p = d.html); else {
                    ...
                    s[u] = p;
                    var m = "show".concat(u.charAt(0).toUpperCase()).concat(u.substring(1)), w = n[m];
                ...
                for (var P = 0, I = Object.entries(this.buttons); P < I.length; P++) {
                    ...
                    if (R.hasOwnProperty("event")) {
                        ...
                        for (var E = function () {
                            var t = $r(N[j], 2), e = t[0], n = t[1], o = "string" == typeof n ? window[n] : n;
                ...
                if (n.showColumns) {
                    ...
                    if (a <= n.minimumCountColumns && e.find("input").prop("disabled", !0), e.find("li, label").off("click").on("click", (function (t) {
                        ...
                        var D = e.find('[name="columnsSearch"]'), V = e.find(".dropdown-item-marker");
                        D.on("keyup paste change", (function (e) {
                            var i = e.currentTarget, n = t(i).val().toLowerCase();
            ...
            key: "onSearch", value: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = e.currentTarget,
                    n = e.firedByInitSearchText, o = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
            ...
            key: "initSearch", value: function () {
                ...
                if (this.filterOptions = this.filterOptions || this.options.filterOptions, "server" !== this.options.sidePagination) {
                    ...
                    this.data = e ? this.data.filter((function (i, o) {
                        for (var r = 0; r < t.header.fields.length; r++) if (t.header.searchables[r] && (!t.options.visibleSearch || -1 !== n.indexOf(t.header.fields[r]))) {
                            var a = Qr.isNumeric(t.header.fields[r]) ? parseInt(t.header.fields[r], 10) : t.header.fields[r],
                                s = t.columns[t.fieldsColumnsIndex[a]], l = void 0;
                            if ("string" == typeof a) {
                                l = i;
                            ...
                            if (t.options.searchAccentNeutralise && (l = Qr.normalizeAccent(l)), s && s.searchFormatter && (l = Qr.calculateObjectValue(s, t.header.formatters[r], [l, i, o, s.field], l)), "string" == typeof l || "number" == typeof l) if (t.options.strictSearch) {
                                ...
                                var u = /(?:(<=|=>|=<|>=|>|<)(?:\s+)?(\d+)?|(\d+)?(\s+)?(<=|=>|=<|>=|>|<))/gm.exec(e),
                                    d = !1;
                                if (u) {
                                    var p = u[1] || "".concat(u[5], "l"), f = u[2] || u[3], g = parseInt(l, 10),
                                        v = parseInt(f, 10);
                                    switch (p) {
                                        case">":
                                        case"<l":
            ...
            key: "initPagination", value: function () {
                ...
                if (e.pagination) {
                    ...
                    var i, n, o, r, a, s, l, c = [], h = !1, u = this.getData({includeHiddenRows: !1}), d = e.pageList;
            ...
            key: "initRow", value: function (t, e, i, n) {
                var o = this, r = [], a = {}, s = [], l = "", c = {}, h = [];
                if (!(Qr.findIndex(this.hiddenRows, t) > -1)) {
                    ...
                    return Qr.hasDetailViewIcon(this.options) && (T = "<td>", Qr.calculateObjectValue(null, this.options.detailFilter, [e, t]) && (T += '\n          <a class="detail-icon" href="#">\n          '.concat(Qr.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen), "\n          </a>\n        ")), T += "</td>"), T && "right" !== this.options.detailViewAlign && r.push(T), this.header.fields.forEach((function (i, n) {
                        var a = "", l = Qr.getItemField(t, i, o.options.escape), c = "", h = "", u = {}, d = "",
                            p = o.header.classes[n], f = "", g = "", v = "", b = "", y = "", m = "", w = o.columns[n];
            ...
            key: "initBodyEvent", value: function () {
                ...
                this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", (function (i) {
                    var n = t(i.currentTarget), o = n.parent(), r = t(i.target).parents(".card-views").children(),
                        a = t(i.target).parents(".card-view"), s = o.data("index"), l = e.data[s],
                        c = e.options.cardView ? r.index(a) : n[0].cellIndex,
                        h = e.getVisibleFields()[c - Qr.getDetailViewIndexOffset(e.options)],
                        u = e.columns[e.fieldsColumnsIndex[h]], d = Qr.getItemField(l, h, e.options.escape);
                    ...
                    if (o) {
                        ...
                        var r = e.header.fields[n], a = e.getVisibleFields().indexOf(r);
                        if (-1 !== a) {
                            ...
                            var s = function (i) {
                                ...
                                e.$body.find(">tr:not(.no-records-found)").each((function (o, s) {
                                    var l = t(s),
                                        ...
                                        h = i.indexOf(" "), u = i.substring(0, h), d = i.substring(h + 1);
                                    c.find(d).off(u).on(u, (function (t) {
                                        var i = l.data("index"), o = e.data[i], a = o[r];
                                        n.apply(e, [t, a, o, i])
                                    }))
                                }))
                            };
            ...
            key: "initServer", value: function (e, i, n) {
                var o = this, r = {}, a = this.header.fields.indexOf(this.options.sortName), s = {
                ...
                if (this.$el.is(":hidden")) this.timeoutId_ = setTimeout((function () {
                    ...
                    u.find("> *").each((function (i, n) {
                        ...
                        if (Qr.hasDetailViewIcon(e.options) && (0 === i && "right" !== e.options.detailViewAlign || i === d - 1 && "right" === e.options.detailViewAlign)) {
                            var r = h.filter(".detail"), a = r.innerWidth() - r.find(".fht-cell").width();
                ...
                if (this.options.showFooter && !this.options.cardView) {
                    ...
                    try {
                        for (var a, s = this.columns[Symbol.iterator](); !(n = (a = s.next()).done); n = !0) {
                            var l, c, h = a.value, u = [], d = {}, p = Qr.sprintf(' class="%s"', h.class);
            ...
            key: "fitFooter", value: function () {
                ...
                if (this.$el.is(":hidden")) setTimeout((function () {
                    ...
                    var o = this.$tableFooter.find("th"), r = this.$body.find(">tr:first-child:not(.no-records-found)");
                    ...
                    r.find("> *").each((function (i, n) {
                        ...
                        if (Qr.hasDetailViewIcon(e.options) && (0 === i && "left" === e.options.detailViewAlign || i === a - 1 && "right" === e.options.detailViewAlign)) {
                            ...
                            var c = o.eq(i), h = c.innerWidth() - c.find(".fht-cell").width();
            ...
            key: "getVisibleFields", value: function () {
                ...
                try {
                    for (var o, r = this.header.fields[Symbol.iterator](); !(e = (o = r.next()).done); e = !0) {
                        var a = o.value, s = this.columns[this.fieldsColumnsIndex[a]];
            ...
            key: "getData", value: function (t) {
                ...
                return t && t.formatted && i.forEach((function (t) {
                    for (var i = 0, n = Object.entries(t); i < n.length; i++) {
                        var o = $r(n[i], 2), r = o[0], a = o[1], s = e.columns[e.fieldsColumnsIndex[r]];
                        if (!s) return;
            ...
            key: "updateRow", value: function (e) {
                var i = Array.isArray(e) ? e : [e], n = !0, o = !1, r = void 0;
                try {
            ...
            key: "getRowByUniqueId", value: function (t) {
                var e, i, n, o = this.options.uniqueId, r = t, a = null;
            ...
            key: "updateCellByUniqueId", value: function (t) {
                ...
                (Array.isArray(t) ? t : [t]).forEach((function (t) {
                    var i = t.id, n = t.field, o = t.value, r = e.options.data.indexOf(e.getRowByUniqueId(i));
            ...
            key: "getHiddenRows", value: function (t) {
                ...
                var e = this.getData(), i = [], n = !0, o = !1, r = void 0;
                try {
            ...
            key: "mergeCells", value: function (t) {
                var e, i, n = t.index, o = this.getVisibleFields().indexOf(t.field), r = t.rowspan || 1,
                    a = t.colspan || 1, s = this.$body.find(">tr");
            ...
            key: "checkInvert", value: function () {
                var e = this.$selectItem.filter(":enabled"), i = e.filter(":checked");
                e.each((function (e, i) {
            ...
            key: "resetView", value: function (t) {
                ...
                if (t && t.height && (this.options.height = t.height), this.$selectAll.prop("checked", this.$selectItem.length > 0 && this.$selectItem.length === this.$selectItem.filter(":checked").length), this.$tableContainer.toggleClass("has-card-view", this.options.cardView), !this.options.cardView && this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), e += this.$header.outerHeight(!0) + 1) : (this.$tableHeader.hide(), this.trigger("post-header")), !this.options.cardView && this.options.showFooter && (this.$tableFooter.show(), this.fitFooter(), this.options.height && (e += this.$tableFooter.outerHeight(!0))), this.$container.hasClass("fullscreen")) this.$tableContainer.css("height", ""), this.$tableContainer.css("width", ""); else if (this.options.height) {
                    ...
                    var i = this.$toolbar.outerHeight(!0), n = this.$pagination.outerHeight(!0),
                        o = this.options.height - i - n, r = this.$tableBody.find(">table"), a = r.outerHeight();
            ...
            key: "filterBy", value: function (e, i) {
            ...
            key: "expandRow", value: function (t, e) {
                var i = this.data[t], n = this.$body.find(Qr.sprintf('> tr[data-index="%s"][data-has-detail-view]', t));
                if (!n.next().is("tr.detail-view")) {
                    ...
                    var o = n.next().find("td"), r = e || this.options.detailFormatter,
            ...
            key: "collapseRow", value: function (t) {
                var e = this.data[t], i = this.$body.find(Qr.sprintf('> tr[data-index="%s"][data-has-detail-view]', t));
    ...
    return ta.VERSION = Br.VERSION, ta.DEFAULTS = Br.DEFAULTS, ta.LOCALES = Br.LOCALES, ta.COLUMN_DEFAULTS = Br.COLUMN_DEFAULTS, ta.METHODS = Br.METHODS, ta.EVENTS = Br.EVENTS, t.BootstrapTable = ta, t.fn.bootstrapTable = function (e) {
        ...
        return this.each((function (i, o) {
            var a = t(o).data("bootstrap.table"), s = t.extend({}, ta.DEFAULTS, t(o).data(), "object" === Tr(e) && e);
            if ("string" == typeof e) {
                var l;
