                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control" name="sid" id="sid">
                                    ...
                                    <option value="1">小狗</option>
                                    <option value="2">小猫</option>
                                    <option value="3">其他宠物</option>
...
<script>
    ...
    $('#table').bootstrapTable({
        ...
        columns: [{
            ...
            width:'220px',
            formatter: function (value, row, index) {
                var btn1 = '<a class="btn btn-success "  href="petDetail?id='+row.id+'">查看</a>';
                ...
                var btn5 = '<button style="margin-left: 10px" class="btn btn-danger " onclick="addFeeder('+row.id+')">预定</button>';
                ...
                if(role == 2) {
                    ...
                    console.log(row.feeder)
                    if(row.feeder) {
                        return btn1 + btn4
                    }else {
                        return btn1 + btn4 + btn5
                    }
